...
from apps import forecast, statistics, map, preditor, inicio
...
app.layout = html.Div([
    ...
    html.Header([
        ...
        html.Img(src=app.get_asset_url('imagenes/imageCforecast.png')),
        dcc.Link('Crime forecasting', href='/apps/forecast',className="likns"),
